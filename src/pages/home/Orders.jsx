...
const Orders = () => {
  ...
  const onOrderSubmit = async () => {
    ...
    if ((name === "") | (address === "") | (phone === "")) {
      setLoading(false);
      return toast.error("Enter your name, address and mobile number correctly.", {
        position: "top-right",
        autoClose: 4000,
        theme: "dark",
      });
      ...
      try {
        ...
        if (response.ok) {
          ...
          toast.success(
            "Order completed. You will be contacted shortly. Thank you!",
            {
              position: "top-right",
              autoClose: 4000,
              theme: "dark",
              ...
              <div className="w-full lg:w-1/2 mt-8 lg:mt-0">
                ...
                <div className="w-full mt-3">
                  ...
                  <div className="flex justify-between items-center py-6">
                    <h1 className="font-light">Cash on Delivery Charge 1%</h1>
                    <h1 className="font-semibold text-green-500">
